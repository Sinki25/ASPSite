...
namespace ASP.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //    {
        //        ApplicationUser user = new ApplicationUser { UserName = model.Name, Email = model.Email, Year = model.Year, PasswordHash=model.Password };
        //        IdentityResult result = await UserManager.CreateAsync(user, model.Password);
        //        if (result.Succeeded)
        //        {
        //            return RedirectToAction("Auth", "Reg");
        //        }
        //        else
        //        {
        ...
        public async Task<ActionResult> Registration(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, Year = model.Year, PasswordHash = model.Password };
